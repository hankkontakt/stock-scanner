...
US_LARGE_CAP = [
    ...
    "CHK", "SWN", "EQT", "CNX", "MUR", "MRO", "FANG", "PR", "MTDR", "PEG", "AEE", 
    "AWK", "PNW", "OGE",
...
EUROPE = [
    ...
    "RMS.PA", "KER.PA", "RNO.PA", "STLAP.PA", "JD.L", "NXT.L", "CFR.SW", "CFR.SW", 
    ...
    "HOLN.SW", "AKZA.AS", "IMCD.AS", "NSIS-B.CO", "NSIS-B.CO", "UPM.HE", "KEMIRA.HE", 
    "METSB.HE", "MT.AS",
